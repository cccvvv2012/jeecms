...
public class UserInfoBizImpl extends BaseBizImpl<UserInfoBean, BasePK> {
	...
	public boolean edit(ActionForm form, HttpServletRequest request) {
		return false;
	}

	public boolean save(ActionForm form, HttpServletRequest request) {
		return false;
	}

	public boolean list(ActionForm form, HttpServletRequest request) {
		return false;
	}

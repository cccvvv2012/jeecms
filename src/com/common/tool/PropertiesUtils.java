...
public class PropertiesUtils {
	...
	private static Properties loadPropertyFile(String propertyFilePath) {
		java.io.InputStream is = PropertiesUtils.class
	...
	public static void main(String[] args) {
		...
		String v = PropertiesUtils.getValue(path, "jdbc.driverClassName");
		_log.info("value0 = " + v);

		Hashtable<String, String> ht = new Hashtable<String, String>();
		ht.put("name", "dengcd");
		PropertiesUtils.setValueAndStore(path, ht);
		String v_ = PropertiesUtils.getValue(path, "name");
		_log.info("value1 = " + v_);
		PropertiesUtils.reloadPropertyFile(path);
		String v2_ = PropertiesUtils.getValue(path, "name");
	...
	public final static boolean setValueAndStore(String propertyFilePath,
		...
		try {
			...
			String path = PropertiesUtils.class.getResource(propertyFilePath)
					.getPath();
